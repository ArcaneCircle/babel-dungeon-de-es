...
A gamified tool for German/Spanish vocabulary learning
...
- The sentences were heavily modified/improved/corrected after extraction from the [Tatoeba](https://tatoeba.org/en/downloads) collection (licensed under CC-BY 2.0)
